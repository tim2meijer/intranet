...
if(isset($_POST['data_opslaan'])) {
	$sql_persoon = "UPDATE $TableUsers SET `$UserGeslacht` = '". addslashes($_POST['geslacht']) ."', `$UserBelijdenis` = '". addslashes($_POST['belijdenis']) ."', `$UserVoorletters` = '". addslashes($_POST['voorletters']) ."', `$UserVoornaam` = '". addslashes($_POST['voornaam']) ."', `$UserTussenvoegsel` = '". addslashes($_POST['tussenvoegsel']) ."', `$UserAchternaam` = '". addslashes($_POST['achternaam']) ."', `$UserMeisjesnaam` = '". addslashes($_POST['meisjesnaam']) ."', `$UserGeboorte` = '". $_POST['jaar'].'-'.$_POST['maand'].'-'.$_POST['dag'] ."', `$UserTelefoon` = '". $_POST['prive_tel'] ."', `$UserMail` = '". $_POST['prive_mail'] ."', `$UserTwitter` = '". $_POST['twitter'] ."', `$UserFacebook` = '". $_POST['fb'] ."', `$UserLinkedin` = '". $_POST['linkedin'] ."'	WHERE `$UserID` = ". $_POST['id'];
